...
//fetch data from only 1 layer
			Mat prob = net.forward("prob");

			cout << "prob.rows: " << prob.rows << " prob.cols: " << prob.cols << endl;
				
			vector <float> probdata = prob;
			cout << "prob[0]: " << probdata[0] << endl;
			cout << "prob[1]: " << probdata[1] << endl;
